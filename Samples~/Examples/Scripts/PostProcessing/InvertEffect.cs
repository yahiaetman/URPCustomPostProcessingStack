...
namespace Yetman.PostProcess {
    ...
    [System.Serializable, VolumeComponentMenu("CustomPostProcess/Invert")]
    public class InvertEffect : VolumeComponent
    {
        [Tooltip("Controls the blending between the original and the inverted color.")]
        public ClampedFloatParameter blend = new ClampedFloatParameter(0, 0, 1);
    }

    // Define the renderer for the custom post processing effect
    [CustomPostProcess("Invert", CustomPostProcessInjectionPoint.AfterPostProcess)]
    public class InvertEffectRenderer : CustomPostProcessRenderer
    {
        // A variable to hold a reference to the corresponding volume component (you can define as many as you like)
        private InvertEffect m_VolumeComponent;
        ...
        {
            m_Material = CoreUtils.CreateEngineMaterial("Hidden/Yetman/PostProcess/Invert");
        }
        ...
        public override bool Setup(ref RenderingData renderingData, CustomPostProcessInjectionPoint injectionPoint)
        {
            ...
            m_VolumeComponent = stack.GetComponent<InvertEffect>();
